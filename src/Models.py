...
"""
This function creates the structure of U-net and perform the training.
...
def unet(input_height, input_width, n_classes):
    ...
    up6 = Conv2D(512, 2, activation='relu', padding='same',
                 data_format='channels_last')(UpSampling2D(size=(2, 2))(drop5))
    ...
    up7 = Conv2D(256, 2, activation='relu', padding='same',
                 data_format='channels_last')(UpSampling2D(size=(2, 2))(conv6))
    ...
    up8 = Conv2D(128, 2, activation='relu', padding='same',
                 data_format='channels_last')(UpSampling2D(size=(2, 2))(conv7))
    ...
    up9 = Conv2D(64, 2, activation='relu', padding='same',
                 data_format='channels_last')(UpSampling2D(size=(2, 2))(conv8))
    merge9 = Add(name='layer_fusion4')([conv1, up9])
    conv9 = Conv2D(64, 3, activation='relu', padding='same',
                   data_format='channels_last')(merge9)
    conv9 = Conv2D(64, 4, activation='relu', padding='same',
...
"""
This function loads the training data and preprocess it to train the model
